...
% Project : AttentionRemapp
% Version : 2.0
% ----------------------------------------------------------------------

if ELflag == 1 % framed box
    Eyelink('command','draw_box %d %d %d %d %d',x-sizeX/2, y-sizeY/2, x+sizeX/2, y+sizeY/2,colorFrm);
elseif ELflag == 2
    Eyelink('command','draw_filled_box %d %d %d %d %d',x-sizeX/2, y-sizeY/2, x+sizeX/2, y+sizeY/2,colorFill);
elseif ELflag == 3
    Eyelink('command','draw_filled_box %d %d %d %d %d',x-sizeX/2, y-sizeY/2, x+sizeX/2, y+sizeY/2,colorFill);
    Eyelink('command','draw_box %d %d %d %d %d',x-sizeX/2, y-sizeY/2, x+sizeX/2, y+sizeY/2,colorFrm);
end
